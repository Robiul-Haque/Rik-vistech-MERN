        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap justify-center">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <p className="mb-7 text-base text-body-color dark:text-dark-6">
                  "Vistech E-learning platform Empowering Growth. Versatile courses for personal and professional development. Learn essential skills for success in a fast-paced world. Start your journey today!"
                </p>
            ...
            <LinkGroup header="Company">
              <NavLink link="/#" label="About Vistech E-learning platform" />
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <p className="text-base text-body-color dark:text-dark-6">
                  &copy; {new Date().getFullYear()} Vistech E-learning platform
                </p>
              </div>
            </div>
          </div>
